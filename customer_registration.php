	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">Sarode Distributors</a>
			</div>
			<ul class="nav navbar-nav">
				<li><a href="home.php"><i class="fas fa-home"></i> Home</a></li>
				<li><a href="index.php"><i class="fas fa-capsules"></i> Product</a></li>
			</ul>
		</div>
	</div>
	<p><br/></p>
				...
				<div class="panel panel-primary">
					...
					<form id="signup_form" onsubmit="return false">
						<div class="row">
							...
							<div class="col-md-6">
								<label for="f_name">Shop Name</label>
						...
						<div class="row">
							<div class="col-md-12">
								<label for="DL_Number">DL_Number</label>
